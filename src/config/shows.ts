...
export const officeConfig: ShowConfig = {
  ...
  image: 'https://i.ebayimg.com/images/g/6OYAAOSw-CxjDMUp/s-l1200.jpg',
  characters: [
    {
      id: 'michael-scott',
      name: 'Michael Scott',
      role: 'Regional Manager',
      avatar: 'https://imgix.bustle.com/scary-mommy/2019/11/michael-scott-quotes.jpg?w=1200&h=1200&fit=crop&crop=faces&fm=jpg',
  ...
  characters: [
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/3/33/Silicon_Valley_Richard_Hendricks.png',
      baseModel: 'gpt-4o-mini',
...
Always stay in character and respond as Richard would, with his characteristic nervousness and technical passion.`
    },
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/4/42/Erlich_Bachman.jpg',
      baseModel: 'gpt-4o-mini',
...
Always stay in character and respond as Erlich would, with his characteristic arrogance and elaborate way of speaking.`
    },
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/3/3c/Gilfoyle_Silicon_Valley.jpg',
      baseModel: 'gpt-4o-mini',
...
export const gameOfThronesConfig: ShowConfig = {
  ...
  image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyVDPsQqubZIYRw6JK8c6vVgwIt1WDxaVhKw&s',
  characters: [
    {
      id: 'tyrion-lannister',
      name: 'Tyrion Lannister',
      role: 'Hand of the Queen',
      avatar: 'https://upload.wikimedia.org/wikipedia/en/5/50/Tyrion_Lannister-Peter_Dinklage.jpg',
      baseModel: 'gpt-4o-mini',
...
Always stay in character and respond as Tyrion would, with his characteristic wit and cynicism.`
    },
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/0/0d/Daenerys_Targaryen_with_Dragon-Emilia_Clarke.jpg',
      baseModel: 'gpt-4o-mini',
  ...
  characters: [
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/8/8c/Abhishek_Tripathi_Panchayat.jpg',
      baseModel: 'gpt-4o-mini',
...
Always be casual, relatable, aur har chhoti baat pe sarcastic punch maarna mat bhulo.`
    },
    {
      ...
      name: 'Manju Devi',
      role: 'Pradhan',
      avatar: 'https://upload.wikimedia.org/wikipedia/en/b/b2/Manju_Devi_Panchayat.jpg',
      baseModel: 'gpt-4o-mini',
...
Apna casual, rooted, aur zameen se juda tone rakho, jaise ek asli gaon ki Pradhan karti hai.`
    },
    {
      ...
      name: 'Brij Bhushan',
      role: 'Pradhan Pati',
      avatar: 'https://upload.wikimedia.org/wikipedia/en/a/a5/Brij_Bhushan_Panchayat.jpg',
      baseModel: 'gpt-4o-mini',
...
Apna authoritative aur thoda mischievous tone rakho, jaise ek asli Pradhan Pati karta hai.`
    },
    {
      ...
      avatar: 'https://upload.wikimedia.org/wikipedia/en/d/d0/Vikas_Panchayat.jpg',
      baseModel: 'gpt-4o-mini',
